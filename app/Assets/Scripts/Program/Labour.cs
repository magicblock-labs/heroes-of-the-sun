...
using Labour;
using Labour.Program;
using Labour.Errors;
using Labour.Accounts;
using Labour.Types;
...
namespace Labour
{
    ...
    namespace Errors
    {
        public enum LabourErrorKind : uint
        {
            LabourIndexOutOfRange = 6000U,
            BuildingIndexOutOfRange = 6001U
        }
    }
    ...
    public partial class LabourClient : TransactionalBaseClient<LabourErrorKind>
    {
        public LabourClient(IRpcClient rpcClient, IStreamingRpcClient streamingRpcClient, PublicKey programId) : base(rpcClient, streamingRpcClient, programId)
        {
        }
        ...
        protected override Dictionary<uint, ProgramError<LabourErrorKind>> BuildErrorsDictionary()
        {
            return new Dictionary<uint, ProgramError<LabourErrorKind>>{{6000U, new ProgramError<LabourErrorKind>(LabourErrorKind.LabourIndexOutOfRange, "Supplied Labour index out range")}, {6001U, new ProgramError<LabourErrorKind>(LabourErrorKind.BuildingIndexOutOfRange, "Supplied Building index out range")}, };
        }
    }
    ...
    namespace Program
    {
        ...
        public static class LabourProgram
        {
