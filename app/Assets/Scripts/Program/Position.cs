...
namespace Position
{
    ...
    {
        public PositionClient(IRpcClient rpcClient, IStreamingRpcClient streamingRpcClient, PublicKey programId) : base(rpcClient, streamingRpcClient, programId)
        {
        }
        ...
        public async Task<Solana.Unity.Programs.Models.ProgramAccountsResultWrapper<List<Position.Accounts.Position>>> GetPositionsAsync(string programAddress, Commitment commitment = Commitment.Confirmed)
        {
