...
namespace Build
{
    ...
    namespace Errors
    {
        public enum BuildErrorKind : uint
        {
            WontFit = 6000U,
            OutOfBounds = 6001U,
            NotEnoughResources = 6002U,
            ConfigIndexOutOfRange = 6003U
        }
    }
    ...
    public partial class BuildClient : TransactionalBaseClient<BuildErrorKind>
    {
        public BuildClient(IRpcClient rpcClient, IStreamingRpcClient streamingRpcClient, PublicKey programId) : base(rpcClient, streamingRpcClient, programId)
        {
        }
        ...
        protected override Dictionary<uint, ProgramError<BuildErrorKind>> BuildErrorsDictionary()
        {
            return new Dictionary<uint, ProgramError<BuildErrorKind>>{{6000U, new ProgramError<BuildErrorKind>(BuildErrorKind.WontFit, "Supplied Building Overlaps With Existing One")}, {6001U, new ProgramError<BuildErrorKind>(BuildErrorKind.OutOfBounds, "Supplied Building Outside Of Settlement Bounds")}, {6002U, new ProgramError<BuildErrorKind>(BuildErrorKind.NotEnoughResources, "Not Enough Resources")}, {6003U, new ProgramError<BuildErrorKind>(BuildErrorKind.ConfigIndexOutOfRange, "Config Index Out Of Bounds")}, };
        }
    }
