...
namespace Time
{
    ...
    namespace Errors
    {
        public enum TimeErrorKind : uint
        {
        }
    }
    ...
    public partial class TimeClient : TransactionalBaseClient<TimeErrorKind>
    {
        public TimeClient(IRpcClient rpcClient, IStreamingRpcClient streamingRpcClient, PublicKey programId) : base(rpcClient, streamingRpcClient, programId)
        {
        }
        ...
        protected override Dictionary<uint, ProgramError<TimeErrorKind>> BuildErrorsDictionary()
        {
            return new Dictionary<uint, ProgramError<TimeErrorKind>>{};
        }
    }
    ...
    namespace Program
    {
        ...
        public static class TimeProgram
        {
