...
namespace Hero
{
    ...
    public partial class HeroClient : TransactionalBaseClient<HeroErrorKind>
    {
        ...
        public async Task<Solana.Unity.Programs.Models.ProgramAccountsResultWrapper<List<SessionToken>>> GetSessionTokensAsync(string programAddress = HeroProgram.ID, Commitment commitment = Commitment.Confirmed)
        {
