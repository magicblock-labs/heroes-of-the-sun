...
namespace StompyRobot.SRF.Scripts.Helpers
{
    public static partial class SRMath
    {
        ...
        /// <summary>
        /// A frame-rate independent way of doing Mathf.Lerp(from, to, UnityEngine.Time.deltaTime * strength). Based on NGUIMath.SpringLerp
        /// </summary>
        /// <param name="from">Starting Value</param>
        /// <param name="to">End Value</param>
        /// <param name="strength">How fast the spring will complete</param>
        /// <param name="deltaTime">Pass in UnityEngine.Time.deltaTime or RealUnityEngine.Time.deltaTime</param>
